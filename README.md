...
* **[commodities-intelligence](https://github.com/henrydate/commodities-intelligence):** cross-asset forecasting system combining oil, gas, FX and equity markets with 30+ macro drivers, built for corporate hedging and portfolio management. Features a **Streamlit dashboard** (8 analytical views: correlation, R², driver ranking, multi-factor models, rolling correlation, price explorer, 90-day LSTM forecasts), full historical data (1997–present from FRED, Yahoo, RBA), frequency-aware statistical analysis (daily returns for prices, annual-horizon for macro), and a deep Australia-specific write-up on what moves the ASX 200 and AUD — finding that the RBA cash rate has zero independent effect on the index once global factors are accounted for.
